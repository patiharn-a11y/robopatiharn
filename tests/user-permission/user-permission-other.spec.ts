...
test.describe('User Permission Other Role', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    // Prerequisite: Login as Super Admin and navigate to Permission Settings of the IIC account
  ...
  test('TC-10 ตรวจสอบว่า Other Role ที่ไม่มีสิทธิ์ Manage Portfolio ของ Customer จะไม่เห็น Action Button', async ({ page }) => {
    ...
    await test.step('4. Search หารอน วีสลีย์ และ Expand ดู Account แรกของ รอน', async () => {
